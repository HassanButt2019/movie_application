...
class TopRatedMovieListView extends StatefulWidget {
  String? title;


  TopRatedMovieListView({this.title });

  @override
  _TopRatedMovieListViewState createState() => _TopRatedMovieListViewState();
}

class _TopRatedMovieListViewState extends State<TopRatedMovieListView> {
  double?width;
  double?height;
      ...
      children: [
        ...
        Container(
          ...
          child: StreamBuilder<List<Movie>>(
              initialData:BlocProvider.of<MovieBloc>(context).topRatedmovies,
              stream: BlocProvider.of<MovieBloc>(context).topRatedMoviesStream,
                    ...
                    children: [
                      ListView.builder(
                        controller: scrollController
                          ..addListener(() {
                            if (scrollController.position.pixels==
                              ...
                              BlocProvider.of<MovieBloc>(context).getTopMovies();
                            }
                          }),
                        //shrinkWrap: true,
                        ...
                        itemBuilder: (context, index) {
                          var movies = BlocProvider.of<MovieBloc>(context).topRatedmovies;
